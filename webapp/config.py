...
APP_NAME = "webitgpt"
VERSION = "1.0.1.71"
PATCH_ID = "opening-system-scope"
RELEASE_NOTE = "開門檢查改為系統範圍檢視，深度檢查支援 Linux/RHEL/Debian/CentOS 與 AIX 入口"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 20:10:00 +08:00")
