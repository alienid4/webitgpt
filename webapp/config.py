...
APP_NAME = "webitgpt"
VERSION = "1.0.2.23"
PATCH_ID = "opening-host-display-name-os"
RELEASE_NOTE = "開門檢查主機卡片改顯示資產名稱與 OS 真實版本，避免以資產編號作為主標題"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 15:40:00 +08:00")
