...
APP_NAME = "webitgpt"
VERSION = "1.0.2.15"
PATCH_ID = "opening-compact-metrics"
RELEASE_NOTE = "開門檢查資源與檔案系統卡片改為短指標顯示：CPU、MEMORY、SWAP、Filesystem、IO"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 12:20:00 +08:00")
