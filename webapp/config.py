...
APP_NAME = "webitgpt"
VERSION = "1.0.1.77"
PATCH_ID = "manager-readable-remedy"
RELEASE_NOTE = "深度檢查建議改為主管可讀說明，避免 setroubleshootd 誤解為 SELinux 開關問題"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 21:35:00 +08:00")
