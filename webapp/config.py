...
APP_NAME = "webitgpt"
VERSION = "1.0.2.25"
PATCH_ID = "global-search-admin-routing"
RELEASE_NOTE = "全站搜尋可直接找到後台功能，支援資產治理狀態、等待防火牆、弱掃與 PAM 納管關鍵字"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 16:18:00 +08:00")
