...
APP_NAME = "webitgpt"
VERSION = "1.0.2.32"
PATCH_ID = "asset-guest-action-guard"
RELEASE_NOTE = "資產管理依權限隱藏編輯、自檢與 Debug 操作，Guest/Viewer 不再看到不可用按鈕"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 19:55:00 +08:00")
