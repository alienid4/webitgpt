...
APP_NAME = "webitgpt"
VERSION = "1.0.1.60"
PATCH_ID = "admin-console-chinese-modules"
RELEASE_NOTE = "補齊系統管理與開發後台中文化，模組管理顯示控制範圍與關閉影響"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 09:30:00 +08:00")
