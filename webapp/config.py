...
APP_NAME = "webitgpt"
VERSION = "1.0.1.85"
PATCH_ID = "asset-scan-modes"
RELEASE_NOTE = "資產網段掃描新增混合模式，整合 ARP/Ping 與 TCP 常見服務探測並顯示開放服務與發現方式"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 23:35:00 +08:00")
