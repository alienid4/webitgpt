...
APP_NAME = "webitgpt"
VERSION = "1.0.2.36"
PATCH_ID = "scan-preserve-last-result"
RELEASE_NOTE = "掃描與盤點類功能規則化保留上次結果，資產網段掃描新增預設顯示最近一次結果"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 21:05:00 +08:00")
