...
APP_NAME = "webitgpt"
VERSION = "1.0.2.26"
PATCH_ID = "global-search-expanded-index"
RELEASE_NOTE = "擴充全站搜尋索引，納入主選單、資產/IPAM、系統管理、開發後台、盤點與拓撲常用關鍵字"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 18:50:00 +08:00")
