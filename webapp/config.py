...
APP_NAME = "webitgpt"
VERSION = "1.0.2.34"
PATCH_ID = "asset-create-workbench"
RELEASE_NOTE = "資產管理新增主機工作台整合單筆新增、CSV 匯入與網段掃描建立草稿流程"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 20:20:00 +08:00")
