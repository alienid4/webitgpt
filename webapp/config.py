...
APP_NAME = "webitgpt"
VERSION = "1.0.1.107"
PATCH_ID = "l3-summary-recompute"
RELEASE_NOTE = "L3 深度檢查讀取舊報告時重新計算新版短摘要，避免沿用舊 raw summary"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 10:55:00 +08:00")
