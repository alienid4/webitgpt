...
APP_NAME = "webitgpt"
VERSION = "1.0.2.31"
PATCH_ID = "asset-quality-report"
RELEASE_NOTE = "資產管理新增資產異常清單，集中呈現 CMDB 資料品質、IP 衝突與掃描不一致問題"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 19:45:00 +08:00")
