...
APP_NAME = "webitgpt"
VERSION = "1.0.1.61"
PATCH_ID = "opening-deep-check-complete"
RELEASE_NOTE = "補齊開門檢查與 L3 深度檢查，加入 9 面向、Mongo job、歷史報告與 Remedy KB"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 17:20:00 +08:00")
