...
APP_NAME = "webitgpt"
VERSION = "1.0.1.78"
PATCH_ID = "deep-preview-plain-text"
RELEASE_NOTE = "深度檢查摘要預覽改為 UTF-8 純文字，不再顯示 JSON 跳脫內容"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 21:45:00 +08:00")
