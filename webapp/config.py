...
RELEASE_NOTE = "資產管理 KPI 改為資產池治理口徑：匯入資料先全部自動納入，只有草稿、缺關鍵欄位或衝突資料列為人工待判斷，避免把完整度數字誤解為匯入總數。"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-06-03 13:45:00 +08:00")
