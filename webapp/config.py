...
APP_NAME = "webitgpt"
VERSION = "1.0.2.14"
PATCH_ID = "executive-visual-dashboard"
RELEASE_NOTE = "主管儀表板第一階段內建圖表上線，Prometheus 與 Grafana 列入後續待辦"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 12:10:00 +08:00")
