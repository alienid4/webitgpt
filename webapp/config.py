...
APP_NAME = "webitgpt"
VERSION = "1.0.1.94"
PATCH_ID = "deep-check-network-sn"
RELEASE_NOTE = "L3 網路檢查補上 NET-01 到 NET-07 檢查點 SN、證據摘要與處置指令"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 00:20:00 +08:00")
