...
APP_NAME = "webitgpt"
VERSION = "1.0.1.53"
PATCH_ID = "topology-action-feedback"
RELEASE_NOTE = "拓撲採集與 ss+nmap 對帳按鈕新增執行回饋，並自動清理卡住的採集狀態"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-13 10:05:00 +08:00")
