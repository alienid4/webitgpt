...
APP_NAME = "webitgpt"
VERSION = "1.0.1.30"
PATCH_ID = "topology-port-detail-no-overlap"
RELEASE_NOTE = "拓撲 Port 資訊改為滑鼠提示與明細清單，避免圖上文字重疊"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-12 22:02:00 +08:00")
