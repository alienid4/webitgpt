...
APP_NAME = "webitgpt"
VERSION = "1.0.2.28"
PATCH_ID = "system-admin-search-shortcuts"
RELEASE_NOTE = "系統管理加入 SA.A 到 SA.H 搜尋快捷代碼，可直接進入常用後台管理頁"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 19:15:00 +08:00")
