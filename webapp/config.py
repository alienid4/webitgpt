...
APP_NAME = "webitgpt"
VERSION = "1.0.2.24"
PATCH_ID = "asset-governance-status-admin"
RELEASE_NOTE = "新增資產治理狀態字典與後台管理，預留等待防火牆、弱掃與 PAM 納管流程"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 16:05:00 +08:00")
