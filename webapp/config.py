...
APP_NAME = "webitgpt"
VERSION = "1.0.2.12"
PATCH_ID = "opening-human-connectivity"
RELEASE_NOTE = "開門檢查連線狀態改為非 IT 也能理解的摘要，raw uptime 不直接顯示在卡片"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 11:50:00 +08:00")
