...
APP_NAME = "webitgpt"
VERSION = "1.0.1.84"
PATCH_ID = "asset-new-workbench"
RELEASE_NOTE = "資產新增改為同頁工作台，整合單筆新增、CSV 匯入與 nmap 網段掃描勾選建立草稿"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 23:20:00 +08:00")
