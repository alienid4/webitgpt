...
APP_NAME = "webitgpt"
VERSION = "1.0.2.33"
PATCH_ID = "dev-login-default-password"
RELEASE_NOTE = "修正開發期 superadmin/admin 預設登入密碼，避免部署或驗證後無法用既定帳密登入"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 20:05:00 +08:00")
