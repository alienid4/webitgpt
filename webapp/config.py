...
APP_NAME = "webitgpt"
VERSION = "1.0.1.96"
PATCH_ID = "deep-check-readable-time"
RELEASE_NOTE = "L3 最近檢查時間改成 YYYYMMDD HH:MM 顯示，保留原始 timestamp 做檔名與追溯"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-16 09:15:00 +08:00")
