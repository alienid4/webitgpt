...
APP_NAME = "webitgpt"
VERSION = "1.0.1.67"
PATCH_ID = "asset-actions-account-metrics"
RELEASE_NOTE = "調整資產操作按鈕權限與樣式，並讓帳號盤點統計卡可點擊查看明細"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-15 19:05:00 +08:00")
