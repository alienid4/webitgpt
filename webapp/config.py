...
RELEASE_NOTE = "新增 API Key 型安裝後驗證端點與腳本模式，可用 system:read token 判斷版本、Mongo 與資料品質 API"
BUILD_TIME = os.environ.get("WEBITGPT_BUILD_TIME", "2026-05-26 23:45:00 +08:00")
