...
def main() -> int:
    ...
    check(report, "ui_version_visible", status == 200 and "webitgpt v1.0.2.35" in home_page and "asset-lifecycle-actions" in home_page and "IT 巡檢系統" in home_page, {"status": status})
