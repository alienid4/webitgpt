...
def main() -> int:
    ...
    check(report, "ui_version_visible", status == 200 and "webitgpt v1.0.2.11" in home_page and "opening-remember-system" in home_page and "IT 巡檢系統" in home_page, {"status": status})
