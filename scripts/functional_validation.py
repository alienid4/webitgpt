...
def main() -> int:
    ...
    check(report, "ui_version_visible", status == 200 and "webitgpt v1.0.2.52" in home_page and "account-risk-nowrap" in home_page and "IT 巡檢系統" in home_page, {"status": status})
